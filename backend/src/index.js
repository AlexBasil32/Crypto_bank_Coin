...
app.get("/", (req, res) => {
  fs.readFile(path.resolve(__dirname, "../../frontend/dist/index.html"), {
    encoding: "utf-8"
  }).then((data) => {
    res.send(data);
  });
...
app.get("/account/details/:id", (req, res) => {
  fs.readFile(path.resolve(__dirname, "../../frontend/dist/index.html"), {
    encoding: "utf-8"
  }).then((data) => {
    res.send(data);
...
app.get("/account/details/history/:id", (req, res) => {
  fs.readFile(path.resolve(__dirname, "../../frontend/dist/index.html"), {
    encoding: "utf-8"
  }).then((data) => {
    res.send(data);
